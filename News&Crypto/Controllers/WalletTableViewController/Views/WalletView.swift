...
final class WalletView: UIView {
    ...
    private let mainWalletView = UIView()
    ...
    private let chartAndExchangeStackView = UIStackView()
    private let chartView = CryptoLineChartView()
    private let binanceImageView = UIImageView()
    private let krakenImageView = UIImageView()
    private let bitfinexImageView = UIImageView()
    ...
    private func addSubviews() {
        ...
        mainStackView.addAllArrangedSubviews(nameAndIconStackView,
                                          currentPriceLabel,
                                          changeStackView,
                                          chartAndExchangeStackView)
        nameAndIconStackView.addAllArrangedSubviews(nameCoinLabel,
                                                 coinImageView)
        changeStackView.addAllArrangedSubviews(changeImageView,
                                            changeLabel)
        chartAndExchangeStackView.addAllArrangedSubviews(chartView, spacer, binanceImageView, krakenImageView, bitfinexImageView)
    }
    ...
    private func addCurrentPriceLabelSetups() {
        ...
        currentPriceLabel.font = .montserrat(30, .bold)
    }
    ...
    private func addChangeLabelSetups() {
        ...
        changeLabel.font = .montserrat(15, .regular)
